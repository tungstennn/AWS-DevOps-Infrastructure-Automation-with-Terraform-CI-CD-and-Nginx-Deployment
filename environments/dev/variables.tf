...
# VPC variables______________________________
variable "cidr_block" {
...
variable "subnet_cidr_block" {
  ...
  type        = string
  default     = "10.0.1.0/30" # for the dev environment
}

# Security Group variables______________________________
...
# EC2 variables______________________________
